...
class Transaction:
    ...
    def compute_payload_hash(self):
        ...
        """
        Shoshana-> [01110011, 01101000, 01101111, 01110011, 01101000, 01100001, 01101110, 01100001] 
        """
    ...
    def validate_integrity(self):
        ...
        if self.payload_hash != self.compute_payload_hash() or self.trans_hash != self.__compute_trans_hash():
            raise transactionException.TransactionException("Tempered transaction number = " + str(self))
